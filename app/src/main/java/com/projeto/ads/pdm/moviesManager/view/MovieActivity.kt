...
class MovieActivity : AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMovieBinding.saveBt.setOnClickListener {
            ...
            if (movieName.isNullOrEmpty() || movieYear.isNullOrEmpty() || movieYear.isNullOrEmpty() || movieDuration.isNullOrEmpty() || movieGenre.isNullOrEmpty()) Toast.makeText(this, "Existem campos preenchidos incorretamente.", Toast.LENGTH_SHORT).show()
            else {
                val movie = Movie(
                    name = movieName,
